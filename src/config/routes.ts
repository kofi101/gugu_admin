export const routes = {
  eCommerce: {
    ...
    productConfigs: '/products/configs',
  ...
  //admin routes
  admin: {
    merchants: '/admin/business/merchants',
    customers: '/admin/business/customers',
    pending_product: '/admin/products/pending',
    approved_products: '/admin/products/approved',
    business_info: '/admin/user-control/business-info',
    roles: '/admin/user-control/roles',
    analytics: '/admin/analytics',
    product_configs: '/admin/products/configs',
  },
};
